...
#. **Получение новых событий**: обработка новых событий в ящике производится в несколько этапов.
	...
	#. Получите новые события с помощью метода :doc:`GetEvents <../methods/GetEvents>`, в параметре **exclusiveEventId** укажите идентификатор последнего обработанного события. Вам вернется список новых событий и идентификатор последнего обработанного события **lastEventId**.
